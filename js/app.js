...
function renderHighlights(){
  ...
  _highlights.forEach(function(h){
    ...
    item.innerHTML='<div style="position:relative;width:60px;height:60px;">'
      ...
      +'</div>'
      +'<button class="hl-edit-btn" title="Edit highlight" style="position:absolute;bottom:-2px;right:-2px;width:20px;height:20px;border-radius:50%;background:var(--pink);border:2px solid var(--card);color:white;font-size:10px;display:flex;align-items:center;justify-content:center;cursor:pointer;padding:0;">✎</button>'
      +'</div>'
